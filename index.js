...
app.get('/users/delete', (req, res) => {
    ...
    const insert_query = `DELETE FROM users WHERE name="${name}"`;
    connection.query(insert_query, (err, results) => {
        if(err) {
            return res.send(err);
        }else{
